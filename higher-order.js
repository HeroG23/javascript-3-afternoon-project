...
//Code Here
let totalPopulation  = populations.reduce(function(acc, curr, array){
  return acc + curr
})
...
//Code Here
let myStrongest = monstersInYourPocket.filter(function(a, b, c){
  return a.CP > 200;
})
...
let orderTotals = orders.map(function(a, b, c){
  return a.price * a.tax + a.price
})
...
let bobsTotal = purchases.filter(function(a,b){
  return a.owner === 'Bob';
  }).map(function(a,b){
    return a.price;
